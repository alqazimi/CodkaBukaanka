            ...
            {editingId === m.id ? (
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                  <button type="button" onClick={() => setEditingId(m.id)} className="rounded-md border border-navy-200 px-3 py-1.5 text-sm">Edit</button>
                  <button type="button" onClick={() => onDelete(m.id)} className="rounded-md border border-red-200 px-3 py-1.5 text-sm text-red-700">Delete</button>
                </div>
              </div>
            )}
          </li>
