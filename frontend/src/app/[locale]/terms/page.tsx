...
export default async function TermsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="font-serif text-3xl font-bold text-navy-900">{t("termsTitle")}</h1>
      <div className="mt-8 space-y-4 text-navy-700">
        ...
        <h2 className="text-xl font-semibold text-navy-900">No User Submissions</h2>
        <p>
          Visitors cannot create accounts, submit reports, upload media, or post comments. All
          archive content is administrator-managed.
        </p>
        <h2 className="text-xl font-semibold text-navy-900">Disclaimer</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-navy-900">Acceptable Use</h2>
        <p>
