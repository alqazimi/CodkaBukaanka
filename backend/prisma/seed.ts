...
async function main() {
  ...
  const insulinCase = await prisma.case.upsert({
    ...
    update: {
      ...
      incidentDescription:
        "Patient received incorrect insulin dosage leading to worsening condition. Documented through administrator-verified medical records and witness interviews.",
    },
    create: {
  ...
  await prisma.case.upsert({
    ...
    create: {
      ...
      incidentDescription:
        "Ali Xakiim was initially misdiagnosed at Akram Hospital. Evidence collected and verified by archive administrators.",
  ...
  await prisma.case.upsert({
    ...
    create: {
      ...
      incidentDescription:
        "Documented delay in emergency department treatment for Fatima Hassan at Banadir Hospital.",
